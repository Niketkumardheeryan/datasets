...
def _patch_dataset_v2(tf):
  ...
  def make_one_shot_iterator(self):
    logging.warning(
        "TFDS has switched to DatasetV2. `ds.make_one_shot_iterator` will be "
        "removed by April 10th.\n"
  ...
  def make_initializable_iterator(self):
    logging.warning(
        "TFDS has switched to DatasetV2. `ds.make_initializable_iterator` will "
        "be removed by April 10th.\n"
